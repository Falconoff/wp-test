...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-wrap mb-4">
    ...
    <div class="post-main p-3 pb-0">
      <h2 class="section-title p-0 mb-0 text-start">
        <a href="<?php echo esc_url(get_permalink()); ?>" title="<?php echo the_title_attribute(); ?>">
          <?php the_title('<h3 data-my="my-h3-test-title">', '</h3>'); ?>
      ...
      <div class="continue-read mt-3">
        <a href="<?php the_permalink(); ?>"><span><?php esc_html_e('Read More', 'laundry-services'); ?></span><span class="screen-reader-text"><?php esc_html_e('Read More', 'laundry-services'); ?></span></a>
      </div>
    </div>
    <div class="adminbox">
